            ...
            <div class="container">
                <div class="privacy about">
                    <h4 class="rad-txt" style="margin-left: 450px">
                        <span class="abtxt1">Document</span>
...
<%} %>
                        <table class="timetable_sub table-responsive">
                            ...
                            List<CertificatesPojo> list=serverDao.loadDocumentRequests();
                            int i=1;
                            ...
                            %>
                                <tr class="rem1">
                                    ...
                                    <td class="invert-i">
                                    <%=certificatesPojo.getEmail() %>
                                    </td>
                                    <td class="invert">
                                    <%=certificatesPojo.getPanCard() %>
                                    </td>
                                    <td class="invert">
                                    <%=certificatesPojo.getAadharCard() %>
                                    </td>
                                    <td class="invert">
                                    <%=certificatesPojo.getVoterId() %>
                                    </td>
                                    <td class="invert">
                                    <%=certificatesPojo.getSslc() %>
                                    </td>
                                    <td>
                                    <button style="background-color: #34c663;height: 30px;width: 100px;border-radius:10px"><a href="documents.jsp?email=<%=certificatesPojo.getEmail() %>" style="color: white;">See Details</a></button>&nbsp;
<%--                                    <button style="background-color: mediumvioletred"><a href="" style="color: white;">Decline</a></button>--%>
                                    </td>
                                </tr>
