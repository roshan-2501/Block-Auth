...
public class ConvertPDFPagesToImages {
    ...
    public void pdftoimage(String doc,String image,String email){
    	try {
            String sourceDir = "webapps/ECSCentralBoardServer/Certificates/"+doc+"/"+ email+"/"+image; // Pdf files are read from this folder
            String destinationDir = "webapps/ECSCentralBoardServer/Certificates/"+doc+"/"+ email+"/"; // converted images from pdf document are saved here
