			...
			%>		
				<div class="col-sm-4 col-md-4 gallery-grids ">
					<div class="thumbnail moments-bottom">
						<a href="decrypted documents/<%=s.replace(".txt", ".png") %>" title="">
							<img src="decrypted documents/<%=s.replace(".txt", ".png") %>" class="img-responsive zoom-img " alt="" style="height: 250px;width: 250px">				
						</a>						
					</div>
