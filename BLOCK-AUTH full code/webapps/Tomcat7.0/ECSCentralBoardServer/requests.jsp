...
<%} %>
                        <table class="timetable_sub table-responsive">
                            ...
                            List<UserPojo> list=serverDao.loadRequests();
                            int i=1;
                            for(UserPojo userPojo:list){
                            	if(userPojo.getUid().equalsIgnoreCase("pending")){
                            %>
                                <tr class="rem1">
                                    ...
                                    <td class="invert"><%=userPojo.getUid() %></td>
                                    <td>
                                    <button style="background-color: #34c663"><a href="AcceptOrDecline?email=<%=userPojo.getEmail() %>&reason=accept" style="color: white;">Approve</a></button>&nbsp;
                                    <button style="background-color: mediumvioletred"><a href="AcceptOrDecline?email=<%=userPojo.getEmail() %>&reason=decline" style="color: white;">Decline</a></button>
                                    </td>
                                </tr>
                                <%}else{%>
                                <tr class="rem1" style="background: gray">
                                    ...
                                    <td class="invert"><%=userPojo.getUid() %></td>
                                   <%
                                   if(!userPojo.getUid().equalsIgnoreCase("declined")){
                                   %>
                                    <td>
                                    Approved
                                    </td>
