	...
	if (input.files && input.files[0]) {
					...
					<div class="logo-nav-left1">
						...
						<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
							<ul class="nav navbar-nav">
								...
								%>
								<%--<li>
									<a href="Aadhar.jsp" class="act">Aadhar </a>
								</li>
								
								<li class="active">
									<a href="Pan.jsp" class="act">Pan</a>
								</li>
								<li>
									<a href="Voter.jsp" class="act">Voter-Id</a>
								</li>
								<li>
									<a href="SSLC.jsp" class="act">SSLC</a>
								</li>
							--%></ul>
						</div>
						</nav>
		...
		<div id="userdetail" media="all">
			...
			<form action="Aadhar" method="get" name="Aadhar"
				...
				<center>
				<font size=15 >Unique Identification Authority of India</font>
					<table cellpadding=2 cellspacing=1 border="1" width="50%"
						...
						<tr bgcolor="lightblue">
							<td valign=top>
								...
								<br>
								<input width="100px" type="hidden" id="Name" name="Type" value="Aadhar" required=" "
									>
								<%
									if (ch.equals("Not")) {
								%>
								...
								<input type="text" name="Name"
									value="<%=map.get("Name")%>" size=20  readonly>
								<%
									}
								%>
							...
							<td align="center">
								<br />
								<img align="middle"  id="blah" src="#" alt="your image" width="100" height="100" />
							</td>
						</tr>
						...
						<tr bgcolor="lightblue">
							<td valign=top>
								...
								<%
									if (ch.equals("Not")) {
								%>
								<input type="text" name="sex" value="" size=20 required=" ">
								<%
									} else {
								%>
								<input type="text" name="sex" size=20
									value="<%=map.get("sex")%>"  readonly>
								<%
									}
								%>
							</td>
							<td valign=top>
								...
								<%
									if (ch.equals("Not")) {
								%>
								<input type="text" name="Aadharno" value="" size=15 required=" ">
								<%
									} else {
								%>
								<input type="text" name="Aadharno" size=20
									value="<%=map.get("Aadharno")%>" "  readonly>
								<%
									}
								%>
							</td>
						...
						<tr bgcolor="lightblue">
							<td valign=top colspan=2>
								...
								%>
								<textarea name="Address" rows="4" cols="45" sixe="80" readonly >
									<%=map.get("Address").toString().trim()%> </textarea>
								<%
									}
								%>
							</td>
